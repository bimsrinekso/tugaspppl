...
scatterChartColors && (scatterChartWidth = $("#scatter-charts").width(), container = document.getElementById("scatter-charts"), data = {
    ...
    tooltip: {
        template: function (t, e) {
            return '<div class="tui-chart-default-tooltip"><div class="tui-chart-tooltip-head">' + e.legend + '</div><table class="tui-chart-tooltip-body"><tr><td>Weight</td><td class="tui-chart-tooltip-value">' + e.x + 'kg</td></tr><tr><td>Height</td><td class="tui-chart-tooltip-value">' + e.y + "cm</td></tr></table></div>"
        }
    }
}, theme = {
    chart: {
