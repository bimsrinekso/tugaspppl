function getChartColorsArray(t) {
    if (null !== document.getElementById(t)) {
        ...
        if (a) return (a = JSON.parse(a)).map(function (t) {
            var a = t.replace(" ", "");
            if (-1 === a.indexOf(",")) {
                var o = getComputedStyle(document.documentElement).getPropertyValue(a);
                return o || a
            }
            var e = t.split(",");
            return 2 != e.length ? a : "rgba(" + getComputedStyle(document.documentElement).getPropertyValue(e[0]) + "," + e[1] + ")"
        });
    ...
    t.prototype.createPlotGraph = function (t, a, o, e, r, l, i, n) {
        ...
        t && this.createPlotGraph("#website-stats", [
            [0, 50],
            [1, 130],
            [2, 80],
            [3, 70],
            ...
            [5, 80],
            [6, 200]
        ], ["Desktops", "Laptops", "Tablets"], t, "rgba(166, 176, 207, 0.1)", "transparent");
        var a = getChartColorsArray("pie-chart-container");
        a && this.createPieGraph("#pie-chart #pie-chart-container", ["Desktops", "Laptops", "Tablets"], [20, 30, 15], a);
        var o, e, r = getChartColorsArray("flotRealTime");
        r && ((o = this.createRealTimeGraph("#flotRealTime", this.randomData(), r)).draw(), e = this),
            function t() {
                o.setData([e.randomData()]), o.draw(), setTimeout(t, (s("html").hasClass("mobile-device"), 1e3))
            }(), getChartColorsArray("donut-chart-container") && this.createDonutGraph("#donut-chart #donut-chart-container", ["Desktops", "Laptops", "Tablets"], [29, 20, 18], ["#f0f1f4", "#556ee6", "#34c38f"])
