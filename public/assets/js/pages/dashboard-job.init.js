...
areacharteathereumColors && (options = {
    series: [{
        name: "Job View",
...
}, (chart = new ApexCharts(document.querySelector("#eathereum_sparkline_charts"), options)).render());
var newApplicationColors = getChartColorsArray("new_application_charts");
newApplicationColors && (options = {
    series: [{
...
}, (chart = new ApexCharts(document.querySelector("#new_application_charts"), options)).render());
var totalApprovedColors = getChartColorsArray("total_approved_charts");
totalApprovedColors && (options = {
    series: [{
        name: "Total Approved",
...
}, (chart = new ApexCharts(document.querySelector("#total_approved_charts"), options)).render()), (totalApprovedColors = getChartColorsArray("total_rejected_charts")) && (options = {
    series: [{
        name: "Total Rejected",
    ...
    colors: totalApprovedColors
}, (chart = new ApexCharts(document.querySelector("#total_rejected_charts"), options)).render());
