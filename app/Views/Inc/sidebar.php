            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="<?= base_url('dashboard/bankAccounts') ?>" key="t-tui-calendar">Bank Accounts</a>
                        </li>
                        <li><a href="<?= base_url('dashboard/qrisAccounts') ?>" key="t-tui-calendar">Qris Accounts</a>
                        </li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="<?= base_url('dashboard/listDeposit') ?>" key="t-tui-calendar">List Deposit</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="<?= base_url('dashboard/withdrawTrans')?>" key="t-tui-calendar">Transaction</a>
                        </li>
                        <li><a href="<?= base_url('dashboard/withdrawPending')?>" key="t-full-calendar">Pending
                                Withdraw</a></li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="<?= base_url('dashboard/makeAdjustment')?>" key="t-tui-calendar">Adjustment</a>
                        </li>
                        <li><a href="<?= base_url('dashboard/calculateComission')?>" key="t-full-calendar">Calculate
                                Commission</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="<?= base_url('dashboard/makeWithdraw')?>" key="t-tui-calendar">Make Withdraw</a>
                        </li>
                        <li><a href="<?= base_url('dashboard/listWithdraw')?>" key="t-full-calendar">List Withdraw</a>
                        </li>
                    </ul>
                </li>
