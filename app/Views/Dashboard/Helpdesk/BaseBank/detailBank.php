                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="bankCode" value="<?=$dataBank->bankCode?>" class="form-control" placeholder="Enter Bank Code">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">Region</label>
                                        <input type="text" name="region" value="<?=$dataBank->region?>" class="form-control" placeholder="Enter Holder Name">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                <label for="formrow-firstname-input" class="form-label">Region Code</label>
                                <input type="text" class="form-control" name="regionCode" value="<?=$dataBank->regionCode?>" id="formrow-firstname-input" placeholder="Region Code">
                            </div>
                            </div>
                            <div>
