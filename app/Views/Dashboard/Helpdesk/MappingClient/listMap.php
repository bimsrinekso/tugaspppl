                                        ...
                                        <?php if($dataMap != null): ?>
                                            ...
                                            <?php foreach($dataMap as $listMap):?>
                                                <tr>
                                                    ...
                                                    <a class="btn btn-outline-danger btn-sm edit" onclick="cbModal(<?=$listMap->idGcl?>)">
...
<script>
    ...
    function cbModal(idGcl){
        $("#noticeDelete").modal("show");
        $("#formDelete").attr("action", "<?= base_url('dashboard/deleteMap'); ?>/" + idGcl);
    }
