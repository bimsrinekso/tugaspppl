...
<script>
    ...
    function filterTgl(targetFilter) {
        ...
        if(tgl == ''){
            generateTable(targetFilter, '/dashboard/monitorDepo', columnListDp, orderListDp);
        }else{
            generateTable(targetFilter, '/dashboard/monitorDepo', columnListDp, orderListDp, startDate, endDate);
        }
    }
    $(document).ready(function () {
        generateTable('#depoRun', '/dashboard/monitorDepo', columnListDp, orderListDp);
        generateTable('#depoExpired', '/dashboard/monitorDepo', columnListDp, orderListDp);
