...
<script>
    ...
    function filterTgl(targetFilter){
        ...
        if(tgl == ''){
            generateTable(targetFilter, '/dashboard/monitorTrans', columnListDpTrans, orderListDpTrans);
        }else{
            generateTable(targetFilter, '/dashboard/monitorTrans', columnListDpTrans, orderListDpTrans, startDate, endDate);
        }
    }
    $(document).ready(function () {
        generateTable("#depoTransConf", '/dashboard/monitorTrans', columnListDpTrans, orderListDpTrans);
        generateTable("#depoTransRej", '/dashboard/monitorTrans', columnListDpTrans, orderListDpTrans);
