                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="avatar-md profile-user-wid mb-4">
                                    <img src="<?= base_url('/assets/'.$_SESSION['avatar']) ?>" alt=""
                            ...
                            <div class="card-body">
                                <form action="<?=base_url('dashboard/filter/filterDash')?>" id="formFilterDash"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <button type="submit" id="kirimBtn" class="btn btn-primary"
                                                        ...
                                                        <div class="card-body">
                                                            <div class="d-flex">
                                                                <div class="flex-grow-1">
                                                                    ...
                                                                    <h4 class="mb-0" id="blcMain">
                                                                        <?= defaultMoney($totalBlcMain, true)?>
                                                                    </h4>
                                                                </div>
                                                                ...
                                                                <div class="flex-shrink-0 align-self-center ">
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            <i
                                                                                class="bx bx-briefcase-alt font-size-24"></i>
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                            </div>
        ...
        $('#formFilterDash').submit(function (event) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#komisiBt").html(formatCurrency(response['komisiBt'], response['locale'], response['currencyCode'], 3));
                    $("#komisiQr").html(formatCurrency(response['komisiQr'], response['locale'], response['currencyCode'], 3));
