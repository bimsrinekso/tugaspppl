                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0"><?= defaultMoney($totalBlcMain, true)?></h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0"><?= defaultMoney($totalBlcClient, true)?></h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0"><?= defaultMoney($totalDepo, true)?></h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0"><?= defaultMoney($totalKomisiDp, true)?></h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0"><?= defaultMoney($totalFeeVaDp, true)?></h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0"><?= defaultMoney($totalWd, true)?></h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0"><?= defaultMoney($totalKomisiWd, true)?></h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0"><?= defaultMoney($totalBankTransfer, true)?></h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0"><?= defaultMoney($totalSettle, true)?></h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0"><?= defaultMoney($totalHo, true)?></h4>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        ...
                                        <h4 class="mb-0"><?= defaultMoney($totalTopup, true)?></h4>
                                    </div>
