            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">List Comission</h4>
                        <div class="card-title-desc">
                            <p>You can create, edit, delete and report comission
                            </p>
                            <a class="btn btn-secondary waves-effect waves-light" href="<?= base_url('dashboard/createCom') ?> ">Create Comission</a>
                        </div>
                                    ...
                                    <tbody>
                                        <?php if ($dataCom != null): ?>
                                            ...
                                            <?php foreach($dataCom as $listCom): ?>
                                                <tr>
                                                    <td><?= $i++ ?> </td>
                                                    <td><?= defaultMoney($listCom->amount) ?> </td>
