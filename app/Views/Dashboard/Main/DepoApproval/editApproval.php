    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Update Approval Deposit</h4> 
                        <form action="" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        <label for="pickStatus" class="form-label">Status Approval</label>
                                        <select id="pickStatus" name="approval" class="form-select select2">
                                            <option></option>
