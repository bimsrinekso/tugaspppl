...
<div class="page-content">
    ...
    <div class="row mb-3">
            <div class="col-md-6">
                <h2>Management Approval Deposit</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">List Approval Deposit</h4>
                        <hr>
                          ...
                          <div class="tab-content mt-3" id="myTabContent">
                            <div class="tab-pane fade show active" id="pending" role="tabpanel" aria-labelledby="pending-tab">
                                ...
                                <table id="datatable-pending" class="table table-striped table-bordered nowrap w-100">
                                    ...
                                    <tbody>
                                        <?php if($dataApproval != null):?>
                                            <div hidden><?= $i = 1; ?></div> 
                                            <?php foreach($dataApproval as $listApprov):?>
                                                <?php
                                                    $accNumber = $listApprov->accNumber == NULL ? '-' : $listApprov->accNumber;
                                                    $bankName = $listApprov->bankName == NULL ? '-' : $listApprov->bankName;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?=  $listApprov->clientName?> 
                                                    </td>
                                                    <td>
                                                         <?= format_date($listApprov->tglbuat, 'd-m-Y H:i:s');?>
                                                    </td>
                                                    <td><a href="<?= base_url("dashboard/depoApproval/update/" . $listApprov->depoid)?> " class="btn btn-outline-secondary btn-sm edit" title="Edit">
