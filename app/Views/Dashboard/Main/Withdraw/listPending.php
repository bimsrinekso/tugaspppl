    ...
    var i = 0;
            $.each(data, function(a, b) {
                ...
                table.append(
                    ...
                    "<td><a href='<?= base_url("dashboard/withdrawPending/edit/" . $listPenWd->reqwd_id) ?>' class='btn btn-outline-secondary btn-sm edit' title='Edit'><i class='fas fa-pencil-alt'></i></a></td>" +
                    "</tr>"
                );
            });
        }
