                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title-desc">
                            <a class="btn btn-secondary waves-effect waves-light" href="<?= base_url('dashboard/createMap') ?> ">Mapping Client</a>
                        </div>
                            ...
                            <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        <?php if($dataMap != null): ?>
                                            <div hidden><?= $i = 1; ?> </div>
                                            <?php foreach($dataMap as $listMap):?>
                                                <tr>
                                                    <td><?=$i++?> </td>
                                                    <td> <?=$listMap->name?></td>
                                                    ...
                                                    <a class="btn btn-outline-danger btn-sm edit" data-bs-toggle="modal" data-bs-target="#hapus<?=$listMap->idGcl?>">
                                            ...
                                            <?php endforeach?>
                                            <?php foreach($dataMap as $listMap) : ?>
                                                <div class="modal fade" id="hapus<?=$listMap->idGcl?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="<?=base_url("dashboard/deleteMap/". $listMap->idGcl)?>" method="post">
